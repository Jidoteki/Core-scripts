...
#
# Copyright (c) 2016-2018 Alexander Williams, Unscramble <license@unscramble.jp>
#
# MIT License
...
version(){
  echo "symlinktool v0.5.1"
  echo "Copyright (c) 2016-2018 Alexander Williams, Unscramble <license@unscramble.jp>"
  echo "License MIT"
}
...
https://github.com/on-prem/tinycore-symlinktool
